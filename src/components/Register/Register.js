...
import { googleProvider, facebookProvider, twitterProvider, githubProvider, auth} from "../../firebase/credenciales"
...
function Register(){
    ...
    const {register,session, isLoading, sessionCheckRegister} = React.useContext(sessionContext)
              ...
              <form onSubmit={submitHandler} id="login">
                ...
                <div className="modosDeInicio">
                  ...
                  <div className="cBoton">
                    <button className="boton" onClick={handleGithubLogin}>
                  ...
                  <div className="cBoton">
                    <button className="boton" onClick={handleFacebookLogin}>
                  ...
                  <div className="cBoton">
                    <button className="boton" onClick={handleTwitterLogin}>
