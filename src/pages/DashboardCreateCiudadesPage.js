    ...
    return (    
        <><br/><div>
            ...
            <Card>
                ...
                <TextField type="text" id='nombre' label="Nombre" defaultValue= {ciudad.nombre ?? ""} onChange={onChange} required/>
            <br/>

                <TextField label="Descripcion" multiline defaultValue={ciudad.descripcion ?? ""} onChange={onChange} required/>
            <br/>
<Typography align="center">
            <label >
                ...
                <TextField type="text" id='text' label="Ambiente" defaultValue= {ciudad.ambiente ?? ""} onChange={onChange} required/>
            <br/>
